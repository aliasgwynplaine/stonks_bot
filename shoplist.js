function processShoplist(prompt, mssg_id, user_id) {
  if (prompt.indexOf("/shopadd")   == 0) return shopadd(prompt, mssg_id, user_id)
  if (prompt.indexOf("/shopclear") == 0) return shopclear()
  if (prompt.indexOf("/shoplist")  == 0) return shoplist()
}

function shopadd(prompt, mssg_id, user_id) {
